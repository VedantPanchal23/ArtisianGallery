              ...
              {/* Header */}
                <div className="checkout-header">
                  ...
                  <div className="secure-badge">
                    <Icon name="shield" size={16} className="icon--inline" /> SSL Encrypted
                  </div>
                </div>              <div className="checkout-content">
                {/* Left Side - Forms */}
                ...
                <div className="order-summary-section">
                  <div className="order-summary-sticky">
                    ...
                    <div className="payment-security">
                      <div className="security-item"><Icon name="shield" size={14} className="icon--inline" /> SSL Encrypted</div>
                      <div className="security-item"><Icon name="check" size={14} className="icon--inline" /> 100% Secure Payment</div>
                    </div>
                  </div>
                </div>
              </div>
