            ...
            <div className="artwork-image-section">
              ...
              <div className="artwork-actions-mobile">
                <button 
                  ...
                  title="Like"
                >
                  <Icon name="heart" size={16} className={`icon--inline ${isLiked ? 'icon--filled' : ''}`} /> {likesCount}
                </button>
                <button 
                ...
                >
                  <Icon name="star" size={16} className={`icon--inline ${isFavorited ? 'icon--filled' : ''}`} />
                </button>
              </div>
            </div>
            ...
            <div className="artwork-info-section">
              <div className="artwork-header">
                ...
                <div className="artwork-meta">
                  ...
                  <span className="views-count"><Icon name="eye" size={14} className="icon--inline" /> {artwork.viewsCount || 0} views</span>
                </div>
              </div>
              ...
              <div className="action-buttons">
                ...
                >
                  {addingToCart ? 'Adding...' : <><Icon name="shopping-cart" size={16} className="icon--inline" /> Add to Cart</>}
                </button>
                <div className="icon-buttons">
                  <button 
                    ...
                    title="Like"
                  >
                    <Icon name="heart" size={20} className={`icon--inline ${isLiked ? 'icon--filled' : ''}`} />
                  </button>
                  <button 
                    ...
                    title="Add to favorites"
                  >
                    <Icon name="star" size={20} className={`icon--inline ${isFavorited ? 'icon--filled' : ''}`} />
                  </button>
                </div>
              </div>
