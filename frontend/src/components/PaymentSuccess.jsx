      ...
      return (
        <div className="payment-success-page">
          <div className="error-container">
            <Icon name="cross" size={48} className="icon--error" />
            <h2>Error</h2>
            <p>{error}</p>
        ...
        <div className="success-container">
          ...
          <div className="success-animation">
            <div className="checkmark-circle">
              <Icon name="check" size={48} className="icon--success" />
            </div>
          </div>
          ...
          <div className="download-notice">
            <p><Icon name="mail" size={16} className="icon--inline" /> Download links have been sent to your email: <strong>{transaction.buyerEmail}</strong></p>
