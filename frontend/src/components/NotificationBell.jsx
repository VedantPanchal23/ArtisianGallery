  ...
  const getNotificationIcon = (type) => {
    switch (type) {
      case 'artwork_approved':
        return <Icon name="check" size={16} className="icon--success" />;
      case 'artwork_rejected':
        return <Icon name="cross" size={16} className="icon--error" />;
      case 'artwork_purchased':
        return <Icon name="creditCard" size={16} className="icon--success" />;
      case 'new_follower':
        return <Icon name="user" size={16} className="icon--accent" />;
      case 'artwork_liked':
        return <Icon name="heart" size={16} className="icon--accent" />;
      case 'order_placed':
        return <Icon name="cart" size={16} className="icon--accent" />;
      case 'price_drop':
        return <Icon name="chevronDown" size={16} className="icon--warning" />;
      case 'new_upload':
        return <Icon name="palette" size={16} className="icon--accent" />;
      default:
        return <Icon name="bell" size={16} className="icon--muted" />;
    }
  };
          ...
          <div className="notification-list">
            {loading ? (
              ...
              <div className="no-notifications">
                <Icon name="bell" size={32} className="icon--muted" />
