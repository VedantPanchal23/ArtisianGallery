            ...
            {[5, 4, 3, 2, 1].map(star => {
              ...
              return (
                <div key={star} className="rating-bar-row">
                  <span className="star-label">{star} <Icon name="star" size={14} className="icon--inline" /></span>
            ...
            <div key={review._id} className="review-item">
              <div className="review-header">
                <div className="reviewer-info">
                  ...
                  {review.verified && (
                    <span className="verified-badge"><Icon name="check" size={12} className="icon--inline" /> Verified Purchase</span>
                  )}
                </div>
              ...
              <div className="review-footer">
                ...
                >
                  <Icon name="thumbs-up" size={14} className="icon--inline" /> Helpful ({review.helpfulCount})
                </button>
