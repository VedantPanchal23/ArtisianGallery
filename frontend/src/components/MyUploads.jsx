...
class MyUploads extends Component {
  ...
  render() {
    var user = this.context.user;
    var { artworks, isLoading, error, stats, filterStatus, showDeleteModal, deletingArtwork, isCheckingAuth } = this.state;
        ...
        <div className="uploads-container">
          ...
          <div className="stats-grid">
            <div className="stat-card">
              <Icon name="palette" size={24} className="stat-icon" />
            ...
            <div className="stat-card">
              <Icon name="check" size={24} className="stat-icon" />
              <div className="stat-info">
            ...
            <div className="stat-card">
              <Icon name="heart" size={24} className="stat-icon" />
              <div className="stat-info">
            ...
            <div className="stat-card">
              <Icon name="dollar-sign" size={24} className="stat-icon" />
              <div className="stat-info">
          ...
          {!isLoading && !error && filteredArtworks.length === 0 && (
            <div className="empty-state">
              <Icon name="palette" size={64} className="empty-icon" />
                ...
                <div key={artwork._id} className="artwork-card">
                  ...
                  <div className="artwork-content">
                    ...
                    <div className="artwork-stats">
                      <span><Icon name="heart" size={14} className="icon--inline" /> {artwork.likesCount || 0}</span>
                      <span><Icon name="eye" size={14} className="icon--inline" /> {artwork.viewsCount || 0}</span>
                      <span><Icon name="shopping-cart" size={14} className="icon--inline" /> {artwork.salesCount || 0}</span>
                    </div>
