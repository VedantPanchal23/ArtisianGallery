        ...
        <div className="upload-container">
          ...
          {successMessage && (
            <div className="success-banner">
              <Icon name="check" size={16} className="icon--success" /> {successMessage}
            </div>
          )}

          {errors.submit && (
            <div className="error-banner">
              <Icon name="cross" size={16} className="icon--error" /> {errors.submit}
            </div>
          )}
                ...
                {imagePreview ? (
                  <div className="image-preview-container">
                    ...
                    <button type="button" className="remove-image-btn" onClick={this.removeImage}>
                      <Icon name="cross" size={16} /> Remove Image
                    </button>
                  </div>
                ) : (
                  <div className="upload-placeholder">
                    <Icon name="folder" size={48} className="icon--muted" />
